package com.minatogithuborg.secretreplacementthree;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborg.secretreplacementthree"})
@EnableCaching
...
public class SecretReplacementThreeApplication {

	public static void main(String[] args) {
		SpringApplication.run(SecretReplacementThreeApplication.class, args);
	}
